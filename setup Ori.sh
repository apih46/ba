...
wget -q -O /usr/bin/installbot "https://raw.githubusercontent.com/apih46/ba/main/bot_panel/installer.sh" && chmod +x /usr/bin/installbot
wget -q -O /usr/bin/bbt "https://raw.githubusercontent.com/apih46/ba/main/bot_panel/bbt.sh" && chmod +x /usr/bin/bbt
mkdir /root/.ctech
